      ...
      <main className="flex-1">
        <section className="border-b border-zinc-200 py-20 dark:border-zinc-800">
          <div className="mx-auto max-w-6xl px-4 text-center sm:px-6">
            <h1 className="text-4xl font-bold text-zinc-900 sm:text-5xl dark:text-zinc-50">Contact Us</h1>
        ...
        <section className="border-b border-zinc-200 py-20 dark:border-zinc-800">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="grid gap-12 md:grid-cols-2">
              <div>
                <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Get in Touch</h2>
                ...
                <form className="mt-8 space-y-6">
                  ...
                  <button
                    type="submit"
                    className="w-full rounded-lg bg-indigo-600 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-indigo-500 sm:w-auto"
                  >
                    Send Message
                  </button>
                </form>
              ...
              <div>
                <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">Our Office</h2>
                <p className="mt-2 text-zinc-600 dark:text-zinc-400">Visit us or reach out through any of these channels.</p>
