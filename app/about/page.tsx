      ...
      <main className="flex-1">
        <section className="border-b border-zinc-200 py-20 dark:border-zinc-800">
          <div className="mx-auto max-w-6xl px-4 text-center sm:px-6">
            <h1 className="text-4xl font-bold text-zinc-900 sm:text-5xl dark:text-zinc-50">About Badhon Byte</h1>
        ...
        <section className="border-b border-zinc-200 py-20 dark:border-zinc-800">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="grid items-center gap-12 md:grid-cols-2">
              <div>
                <h2 className="text-3xl font-bold text-zinc-900 dark:text-zinc-50">Our Story</h2>
              ...
              <div className="rounded-xl border border-zinc-200 bg-zinc-50 p-8 dark:border-zinc-800 dark:bg-zinc-900/50">
                <h3 className="mb-6 text-lg font-semibold text-zinc-900 dark:text-zinc-50">Why choose us?</h3>
        ...
        <section className="py-20">
          <div className="mx-auto max-w-6xl px-4 text-center sm:px-6">
            ...
            <div className="mt-8 inline-flex items-center gap-2 text-zinc-600 dark:text-zinc-400">
              <svg className="h-5 w-5 text-indigo-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
              </svg>
              Hightech Office, Rajpara, Rajshahi, Bangladesh
            </div>
          </div>
        </section>
      </main>
