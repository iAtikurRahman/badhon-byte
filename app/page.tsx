    ...
    <>
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden border-b border-zinc-200 dark:border-zinc-800">
          ...
          <div className="relative mx-auto max-w-6xl px-4 py-24 sm:px-6 sm:py-32 lg:py-40">
            <div className="max-w-2xl">
              <h1 className="text-4xl font-bold leading-tight tracking-tight text-zinc-900 sm:text-5xl lg:text-6xl dark:text-zinc-50">
                Software that
        ...
        <section className="border-b border-zinc-200 py-20 dark:border-zinc-800">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="mb-12 text-center">
              <h2 className="text-3xl font-bold text-zinc-900 sm:text-4xl dark:text-zinc-50">Our Software</h2>
              <p className="mt-4 text-lg text-zinc-600 dark:text-zinc-400">
                Purpose-built solutions to streamline your operations
              </p>
            </div>
            <div className="grid gap-8 md:grid-cols-2">
              <div className="rounded-xl border border-zinc-200 p-8 transition-shadow hover:shadow-lg dark:border-zinc-800">
                ...
                <h3 className="mb-3 text-xl font-semibold text-zinc-900 dark:text-zinc-50">ERP Software</h3>
              ...
              <div className="rounded-xl border border-zinc-200 p-8 transition-shadow hover:shadow-lg dark:border-zinc-800">
                ...
                <h3 className="mb-3 text-xl font-semibold text-zinc-900 dark:text-zinc-50">POS Software</h3>
                <p className="mb-4 text-zinc-600 dark:text-zinc-400">
        ...
        <section className="border-b border-zinc-200 py-20 dark:border-zinc-800">
          <div className="mx-auto max-w-6xl px-4 sm:px-6">
            <div className="mb-12 text-center">
              <h2 className="text-3xl font-bold text-zinc-900 sm:text-4xl dark:text-zinc-50">Simple Pricing</h2>
              <p className="mt-4 text-lg text-zinc-600 dark:text-zinc-400">
                Choose the plan that works best for your business
              </p>
            </div>
            <div className="grid gap-8 md:grid-cols-2">
              <div className="rounded-xl border-2 border-indigo-600 p-8 dark:border-indigo-500">
                <h3 className="mb-2 text-xl font-semibold text-zinc-900 dark:text-zinc-50">Permanent License</h3>
                <p className="mb-4 text-sm text-zinc-600 dark:text-zinc-400">One-time purchase, lifetime use</p>
                <p className="mb-2">
                  <span className="text-4xl font-bold text-zinc-900 dark:text-zinc-50">One-time</span>
                </p>
              ...
              <div className="rounded-xl border border-zinc-200 p-8 dark:border-zinc-800">
                <h3 className="mb-2 text-xl font-semibold text-zinc-900 dark:text-zinc-50">Monthly Service</h3>
                <p className="mb-4 text-sm text-zinc-600 dark:text-zinc-400">Flexible month-to-month subscription</p>
                <p className="mb-2">
                  <span className="text-4xl font-bold text-zinc-900 dark:text-zinc-50">Monthly</span>
                </p>
                <p className="mb-6 text-sm text-zinc-600 dark:text-zinc-400">
        ...
        <section className="py-20">
          <div className="mx-auto max-w-6xl px-4 text-center sm:px-6">
            <h2 className="text-3xl font-bold text-zinc-900 sm:text-4xl dark:text-zinc-50">Visit Our Office</h2>
            <p className="mt-4 text-lg text-zinc-600 dark:text-zinc-400">
              We&apos;d love to hear from you. Drop by or reach out.
            </p>
            <div className="mx-auto mt-8 max-w-md rounded-xl border border-zinc-200 p-8 dark:border-zinc-800">
              ...
              <p className="text-zinc-600 dark:text-zinc-400">Rajshahi, Bangladesh</p>
              <Link
                href="/contact"
                className="mt-6 inline-block rounded-lg bg-indigo-600 px-6 py-3 text-sm font-semibold text-white transition-colors hover:bg-indigo-500"
              >
                Contact Us
              </Link>
            </div>
